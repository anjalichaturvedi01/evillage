...
<head>
    ...
    <!-- Latest compiled and minified CSS (only include this once) -->
...
<div class="row">
    ...
    <div class="col-sm-8" style="background: rgba(1.5, 5.0, 0.5, 0.34); border: 2px dotted #2e6da4; border-radius: 15px; margin-top:30px; font-size:20px; color:#33ff99;">
        <div>
            <form action="contactcode.php" method="post">
                <center>
                    <b style="font-size:35px;text-shadow:2px 2px 2px red;color:black">Contact Us</b>
                </center>
                <br>
                <center>
                    <i class="fa fa-user"></i> Enter your name:
                    <input type="text" name="name" placeholder="Enter your name" class="form-control"><br><br>

                    <i class="fa fa-phone"></i> Enter your Mobile NO:
                    <input type="number" name="mobile" placeholder="Enter your mobile number" class="form-control"><br><br>

                    <i class="fa fa-envelope"></i> Enter your Email Id:
                    <input type="email" name="email" placeholder="Enter your Email Id" class="form-control"><br><br>

                    <i class="fa fa-comment"></i> Enter your Message:
                    <input type="text" name="msg" placeholder="Enter your Message" class="form-control"><br><br>

                    <input type="submit" value="Submit" class="btn btn-success" style="min-height: 16px;color:white;margin-left:5%;border:2px dotted red;font-weight: bold">
                </center>
            </form>
        </div>
    </div>
...
<!-- Footer -->
<div class="row" style="min-height:100px;background:cyan;border:2px solid red">
