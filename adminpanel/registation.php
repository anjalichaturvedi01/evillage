...
// Query to get reg with optional search
$query = "SELECT * FROM reg WHERE name LIKE '%$searchTerm%' OR fathername LIKE '%$searchTerm%' LIMIT $start, $limit";
$result = mysqli_query($conn, $query);

// Query to count total records for pagination
$countQuery = "SELECT COUNT(*) AS total FROM reg WHERE name LIKE '%$searchTerm%' OR gender LIKE '%$searchTerm%'";
...
if (isset($_GET['delete'])) {
    ...
    $query = "SELECT gender FROM reg WHERE id = '$id'";
    $result = mysqli_query($conn, $query);
